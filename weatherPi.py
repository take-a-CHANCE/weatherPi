...
## draw Text
disp.set_rotate(1)
disp.draw_string_at(frame_black, 5, 5, weekday, fontBold, COLORED)
disp.draw_string_at(frame_black, 40, 5, month, font, COLORED)
disp.draw_string_at(frame_black, 100, 5, date, fontBold, COLORED)
